...
const difficultyColors: Record<keyof TasksState, string> = {
  easy: colors.blue100,
  medium: colors.blue75,
  hard: colors.red75,
  extreme: colors.red100,
};
      ...
      {(Object.keys(tasks) as Array<keyof TasksState>).map((difficulty) => (
        <View key={difficulty} style={styles.difficultySection}>
          <View style={styles.difficultyHeader}>
            ...
            >
              <Typo size={verticalScale(22)} color="white" fontWeight="bold">
                {difficulty}
              </Typo>
              <TouchableOpacity
                style={{
                  marginLeft: spacingX._5,
                  marginRight: spacingX._5 * -1,
                }}
              >
                <Feather
                  name="plus"
...
const styles = StyleSheet.create({
  difficultySection: {
    ...
    paddingHorizontal: spacingX._22,
  },
  difficultyHeader: {
    flexDirection: "row",
